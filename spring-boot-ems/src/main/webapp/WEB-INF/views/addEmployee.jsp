...
<form:form    modelAttribute="employee"  method="post"  action="/atos-syntel-ems-mvc/spring/add">
...
<tr>
<td colspan="2"><input type="submit"  class="btn btn-primary"  value="ADD EMPLOYEE"></td>
</tr>
</tbody>
</table>
</form:form>
